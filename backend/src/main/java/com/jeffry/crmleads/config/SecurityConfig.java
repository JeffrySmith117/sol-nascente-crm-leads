package com.jeffry.crmleads.config;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                // publico: o formulario da landing precisa enviar lead sem login
                .requestMatchers(HttpMethod.POST, "/api/leads").permitAll()
                // listar e atualizar status ficam restritos (checagem extra de ADMIN
                // via @PreAuthorize no LeadController)
